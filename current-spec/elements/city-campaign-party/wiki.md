...
7. party 招待で複数人行動に入り、questboard から自分向け候補へつながる
8. board 右クリックか受付 NPC クリックで詳細確認し、/yes /no で受注を決める
...
- 現行の `spawn-safe-radius` は `0` なので、spawn 周辺を広く保護せず、visitor 状態では preview も実設置も止まる
