...
- Trade Shop では商品スロットにカーソルを合わせて `Q` を押すと、その商品を直接目標化して GUI を閉じ、黄色ガラス案内へすぐ移れます。
- Shop 由来の素材は、Shop 窓口そのものよりも、さらに必要になる素材や MythicMob Drop を深く逆探索する方を優先します。
- 途中素材を一部だけ持っている場合も、そこで止めず、不足分を作るための素材分岐をすべて辿ってから同じ素材を合算して表示します。
